...
async function buscarTenis() {
    try {
        const response = await fetch("https://tenix-hpb9amajeza9hucd.brazilsouth-01.azurewebsites.net/api/tenis");
        if (response.ok) {
...
async function salvarAlteracoes(id) {
    ...
    try {
        const response = await fetch(`https://tenix-hpb9amajeza9hucd.brazilsouth-01.azurewebsites.net/api/tenis/${id}`, {
            method: "PUT",
...
async function excluirTennis(id) {
    try {
        const response = await fetch(`https://tenix-hpb9amajeza9hucd.brazilsouth-01.azurewebsites.net/api/tenis/${id}`, { method: "DELETE" });
        if (response.ok) {
...
async function salvarNovoTennis() {
    ...
    try {
        const response = await fetch("https://tenix-hpb9amajeza9hucd.brazilsouth-01.azurewebsites.net/api/tenis/cadastrar", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
